...
(function() {'use strict';var p=void 0,v=!0,da=(typeof exports!=="undefined")?exports:((typeof self!=="undefined")?self:window);function fa(f,e){var c=f.split("."),a=da;for(var b;c.length&&(b=c.shift());)!c.length&&e!==p?a[b]=e:a=a[b]?a[b]:a[b]={}};
...
m>>>24&255;this.i=x;C&&h<d.length&&(this.a=d=d.subarray(0,h));return d};var Pa=255,Oa=2,Ma=8,Na=16;fa("Zlib.Gzip",La);fa("Zlib.Gzip.prototype.compress",La.prototype.g);})();
